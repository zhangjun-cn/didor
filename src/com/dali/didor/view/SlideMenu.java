...
public class SlideMenu extends ViewGroup {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		//return mCurrentScreen == SCREEN_MENU;
		return false;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		if(slideLock.getCurrent() != SlideLock.MENU && slideLock.getCurrent() != SlideLock.NONE) {
			mTouchState = TOUCH_STATE_REST;
		}
	...
	protected void snapToScreen(int whichScreen) {
		...
		if (whichScreen == SCREEN_MENU) {
			this.slideLock.setCurrent(SlideLock.MENU);
		} else {
			this.slideLock.setCurrent(SlideLock.NONE);
		}
